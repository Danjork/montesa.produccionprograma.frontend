  ...
  return (
    <div className="container-fluid p-3 p-md-4">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h1>Consulta y Carga de Órdenes a Program Producción</h1>
        <div className="d-flex gap-2">
          
          <button className="btn btn-secondary">Planificador</button>
        </div>
      </div>
      ...
      <div className="d-flex justify-content-between align-items-center mt-4 flex-wrap gap-3">
        ...
        /**
         <div className="d-flex gap-2">
          <button className="btn btn-outline-secondary">Cargar al Programa</button>
          <button className="btn btn-outline-secondary">Exportar Excel</button>
        </div>
         */
